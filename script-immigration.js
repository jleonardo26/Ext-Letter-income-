...
function generar(){
    ...
    let nameLastname2 = document.getElementById("nameLastname2");
    let nameLastname3 = document.getElementById("nameLastname3");
    ...
    nameLastname2.innerHTML = name + " " + lastname;
    nameLastname3.innerHTML = name + " " + lastname;
...
function limpiar() {
    ...
    document.getElementById("nameLastname2").innerHTML = "";
    document.getElementById("nameLastname3").innerHTML = "";
